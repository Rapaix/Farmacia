...
medicamentos = [
                MedicamentoFitoterapico('Dipirona', 'Dipirona', laboratorio1,
                                  'Dipirona é um analgésico e antitérmico', False, 90.0),
                MedicamentoQuimicoterapico('Dipirona', 'Dipirona', 'Bayer', 'Dipirona é um analgésico e antitérmico', 45.0)
               ]
vendas =  [
...
def medicamentos_em_ordem_afabetica(medicamentos):
  '''
  list_medicamentos_formatado = [
    f'Nome: {medicamento.nome}, '
    f'Composto: {medicamento.principal_composto},'
    f'Laboratorio: {medicamento.laboratorio},'
    f'Descricao: {medicamento.descricao},'

    for medicamento in list_medicamentos
  ]

  for medicamento in list_medicamentos_formatado:
    print(medicamento)

  return list_medicamentos_formatado
  '''
...
# Entrem no grupo https://chat.whatsapp.com/KuLyojaqachKcs57Cy0pzq