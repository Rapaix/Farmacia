...
medicamentos = [
                MedicamentoFitoterapico('Dipirona', 'contém 500 mg de dipirona monoidratada', laboratorio1, 'Dipirona é um analgésico e antitérmico', 'descrição', 90.0),
                MedicamentoQuimicoterapico('Capecitabina', 'Nome comercial Xeloda, é um agente citotóxico', laboratorio2, ' indicadpo para tratamento de primeira linha para pacientes com câncer gástrico em estágio avançado',True, 45.0)
               ]
vendas =  [
